...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  listMeetings: (options) => ipcRenderer.invoke("db-list-meetings", options),
  getMeetingSeriesBrief: (noteId) => ipcRenderer.invoke("meeting-series-brief", noteId),
  getMeetingActivity: (options) => ipcRenderer.invoke("db-meeting-activity", options),
  ...
  setMemoryStatus: (id, status) => ipcRenderer.invoke("memory-set-status", id, status),
  getMeetingsNeedingWriteUp: (limit) => ipcRenderer.invoke("db-meetings-needing-writeup", limit),
  ...
  captureMeetingScreens: (target) => ipcRenderer.invoke("capture-meeting-screens", target),
  ...
  getMeetingKey: () => ipcRenderer.invoke("get-meeting-key"),
