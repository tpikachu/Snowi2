...
//
// All configuration is manual BYOK (stored via environment.js): the
// managed-credential broker that used to distribute workspace identities was
// removed with cloud accounts.
//
