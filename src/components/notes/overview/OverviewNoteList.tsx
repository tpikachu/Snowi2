        ...
        <div key={group.label}>
          ...
          {group.items.map((note) => (
            <button
              ...
              className="w-full flex items-center gap-3 px-2 py-2 -mx-2 rounded-md text-left hover:bg-foreground/4 dark:hover:bg-white/4 transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
