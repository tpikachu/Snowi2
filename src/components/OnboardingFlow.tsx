...
export default function OnboardingFlow({ onComplete }: OnboardingFlowProps) {
  ...
  const steps = useMemo(() => {
    const list = [
      ...
      // No text-size ("Comfort") step: it asked a question most people have no
      // answer to before they have seen the app (client direction, 2026-09-11).
      // The same three sizes live in Settings → Preferences.
    ];
