...
const FAST_ANSWER_SYSTEM_PROMPT = [
  ...
  "date, the name — with **…**. When handing the user a line to say out loud,",
  "put it on its own line wrapped in backticks (`…`) so it stands apart from",
  "advice about it. A short dash list only when genuinely listing, three items",
  "at most. No headings, no tables.",
  "",
