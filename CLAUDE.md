...
- Supports multiple AI providers (all models defined in `src/models/modelRegistryData.json`):
  ...
  - **Local**: GGUF models via llama.cpp (Qwen, Llama, Mistral, GPT-OSS) — hidden while `LOCAL_LLM_ENABLED` is false (see the Language Models paragraph above)
